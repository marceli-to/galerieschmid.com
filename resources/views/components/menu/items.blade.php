...
<li>
  <a href="{{ route('page.contact') }}" class="{{ Route::is('page.contact') ? 'is-active' : '' }}" data-touch="">Kontakt</a>
</li>
<li>
  <a href="{{ route('page.newsletter') }}" class="{{ Route::is('page.newsletter') ? 'is-active' : '' }}" data-touch="">Newsletter</a>
</li>