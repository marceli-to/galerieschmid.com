...
<section class="grid__cell grid__cell--1_3 grid-order--1">
  ...
  <article class="text-media">
    <h1>
      <a href="javascript:;" data-toggle-privacy class="inline-flex items-center !text-crimson !no-underline hover:!underline underline-offset-4 leading-none">
        Datenschutzerklärung
        <x-icons.chevron-down class="block ml-4 w-18 h-18" />
      </a>
    </h1>

    <div class="is-hidden" data-privacy>
