...
use App\Filament\Resources\ArtworkTechniqueResource\Pages;
use App\Filament\Resources\ArtworkTechniqueResource\RelationManagers;
...
class ArtworkTechniqueResource extends Resource
{
  ...
  {
    return [
      'index' => Pages\ListArtworkTechniques::route('/'),
